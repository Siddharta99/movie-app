...
import { asyncloadtv, removeperson } from '../store/actions/tvActions';
...
const TvDetails = () => {
  ...
  return info ? (
    ...
    {info.detail.seasons.length > 0 ? info.detail.seasons.map((s, i) => (
          ...
          <img  className='h-[25vh] object-cover   shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)]'  src={`https://image.tmdb.org/t/p/original/${
      s.poster_path}`}
